...
/**
 * Created by Deni on 15.3.2017 г..
 */
    ...
    public Location getLocation() {
        try {
            ...
            if (!isGPSEnabled && !isNetworkEnabled) {
                Log.d("NOT ENABLED", "NEMA NET I/ILI GPS");
                ...
                if (isNetworkEnabled) {
                    ...
                    if (ActivityCompat.checkSelfPermission(this.mContext, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(this.mContext, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
                        ...
                        //Request runtime permission in order to allow GPS usage;
                        //requestPermissions() method works for API 23 and ABOVE;
                        String[] permisions={Manifest.permission.ACCESS_COARSE_LOCATION, Manifest.permission.ACCESS_FINE_LOCATION};
                        ((AppCompatActivity)mContext).requestPermissions(permisions,12);
...
//
//            MainActivity.DownloadAndParseTask okk=ma.new DownloadAndParseTask();
